...
physeq <- physeq_genera %>% 
  phyloseq::subset_samples(dataset_name == "PROTECT") %>% 
  phyloseq::subset_samples(disease == "UC" & sample_type == "stool") %>% 
...
p_copulaso_renorm <- CRTmicrobiome:::plot_cors(rho_original, rho_copulaso,
                                        c("original", "copulaso")) +
